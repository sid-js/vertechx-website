...
function Navbar() {
  return (
    <nav className=" border-transparent-150 bg-none bg-opacity-20  z-50 sticky top-0 px-14 py-2  ">
      <div className="max-w-screen-3xl flex flex-wrap items-center justify-between mx-auto p-5">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent 
            ...
            <li>
              <Link href="#" class="block py-2 pl-5 pr-4 text-xl font-space text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
            ...
            <li>
              <Link href="/About" class="block py-2 pl-5 pr-4 text-xl font-space text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
            ...
            <li>
              <Link href="/Events" class="block py-2 pl-5 pr-4 text-xl font-space text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
            ...
            <li>
              <Link href="/Contacts" class="block py-2 pl-5 pr-4 text-xl font-space  text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
